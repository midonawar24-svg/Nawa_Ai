...
/// V12: بعد الانتهاء يروح ChatMasterPage مع Fade وليس Dashboard
class BootPageLiving extends StatefulWidget {
  const BootPageLiving({super.key});

  @override
  State<BootPageLiving> createState() => _BootPageLivingState();
}

class _BootPageLivingState extends State<BootPageLiving> with TickerProviderStateMixin {
  ...
  void _finishBoot() {
    // V12: بعد انتهاء Boot -> ChatMasterPage مع Fade وليس Dashboard
    Navigator.pushReplacement(
      context,
      PageRouteBuilder(
        transitionDuration: const Duration(milliseconds: 500),
        pageBuilder: (_, __, ___) => const ChatMasterPage(),
